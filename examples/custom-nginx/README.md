...
```bash
ansible-playbook -i examples/custom-nginx/inventory/hosts.ini examples/custom-nginx/site.yml
```
...
```yaml
nginx_custom_version: "1.26.2"
nginx_custom_source_archive: examples/custom-nginx/files/nginx-1.26.2.tar.gz
```
...
```text
examples/custom-nginx/files/rpms/gcc-*.rpm
examples/custom-nginx/files/rpms/make-*.rpm
examples/custom-nginx/files/rpms/pcre-devel-*.rpm
examples/custom-nginx/files/rpms/zlib-devel-*.rpm
examples/custom-nginx/files/rpms/openssl-devel-*.rpm
examples/custom-nginx/files/rpms/*.rpm
```
